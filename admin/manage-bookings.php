...
{				?>		
						  <tr>
							...
							<td><?php echo htmlentities($result->fdate);?></td><td><?php echo htmlentities($result->tdate);?></td>
...
<?php if($result->status==2)
{
	?><td>Cancelled</td>
<?php } else {?>
<td><a href="manage-bookings.php?bkid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Do you really want to cancel booking')" >Cancel</a> <?php if($result->status==1){ }else{?>/ <a href="manage-bookings.php?bckid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Do you really want to confirm booking')" >Confirm</a><?php } ?></td>
<?php }?>
